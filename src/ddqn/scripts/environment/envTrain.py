'''
This environment is to train the agent.
'''
...
class Env():
    def __init__(
        ...
        param gazebo : (bool) Is gazebo simulator bing run or not.
        param mark_goals : (bool) Weather the goal points must be 
        ...
        # To print the number of cokes picked, timeouts and colisions in n epiisodes frequency
    ...
    def getGoalDistace(self, x, y):
        ...
        locaiton of the robot. If the goal point is not identified, it 
