...
class Respawn():
    def __init__(self, stage=2):
        ...
        self.modelPath = self.modelPath.replace('ddqn/scripts/environment',
                                                'turtlebot_simulator/turtlebot_gazebo/models/coke_can/model.sdf')
        ...
        self.modelName = 'goal'
        self.obstacle_1 = 0.69, 0.0
        self.obstacle_2 = -1.34, 1.65
        self.obstacle_3 = -1.58, -0.97
        self.obstacle_4 = 0.61, -2.08
        self.obstacle_5 = 0.67, -0.45
        self.obstacle_6 = 1.74, 1.05
        self.obstacle_7 = 2.76, -1.06
    ...
    def respawnModel(self):
        while True:
            if not self.check_model:
                ...
                print("Spawned new coke at (" + str(round(self.goal_position.position.x,2)) +", " + str(round(self.goal_position.position.y,2)) + ")")
                break
            else:
                pass
    ...
    def getPosition(self, position_check=False, delete=False):
        if delete and self.check_model:
            self.deleteModel()
